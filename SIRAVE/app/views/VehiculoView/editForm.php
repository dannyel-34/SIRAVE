...
<center>
	<div class="card" style="width: 30rem; margin-top: 38px; background-color: #EBF3F3;">
	  <div class="card-body">
	    <center>
	    	<h5 class="card-title"><b>Editar Vehiculo: 
	    	<?php echo $datos['int_id_vehiculo'];?></b></h5>
	    </center>
	    <form  method="POST"
	    	action="<?php echo RUTA_URL; ?>/VehiculoController/editarVehiculo/<?php echo $datos['int_id_vehiculo']; ?>">
	    	<p class="card-text">		
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" 
			    	name="txtModelo" name="txtModelo" 
			    	value="<?php echo $datos['modelo'];?>">
			  </div>
			  <div class="form-group">
			    <label for="Marca">Marca: </label>
			    <input type="text" class="form-control" 
			    	name="txtMarca" name="txtMarca" 
			    	value="<?php echo $datos['marca'];?>">
			  </div>
			  <div class="form-group">
			    <label for="Clase">Clase: </label>
			    <input type="text" class="form-control" 
			    	name="txtClase" name="txtClase" 
		    ...
		    <button type="submit" name="btnEditar" 
		    	...
		    	<i class="fa fa-edit"></i> Editar Vehiculo
		    </button>
